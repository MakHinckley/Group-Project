...
text = font.render("Hello World", True, text_col)
        ...
        for row in range(rows):
            ...
            for col in range(cols):
                ...
                if row < 2:
                    ...
                    strength = 1
                # create list to store the rect and color data
                block_individual = [rect, strength]
                # append individual block to the block row
...
class game_ball():
    ...
    def move(self):
        ...
        # wall has been destroyed completely
        wall_destroyed = 1
        row_count = 0
        for row in wall.blocks:
            ...
            for item in row:
                ...
                # check if block still exists, wall not destroyed
